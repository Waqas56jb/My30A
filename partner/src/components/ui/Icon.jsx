...
const P = {
  ...
  chart: (
    <>
      <path d="M3.5 21h17" />
      <rect x="5" y="12" width="3.6" height="6.5" rx="1" />
      <rect x="10.2" y="7.5" width="3.6" height="11" rx="1" />
      <rect x="15.4" y="4" width="3.6" height="14.5" rx="1" />
    </>
  ),
  eye: (
    <>
  ...
  eyeOff: (
    <>
      <path d="M10.6 6.7A8.9 8.9 0 0 1 12 6.6c6.4 0 9.8 5.4 9.8 5.4a16 16 0 0 1-3 3.6" />
      <path d="M6.3 7.6A15.6 15.6 0 0 0 2.2 12S5.6 17.4 12 17.4a9.6 9.6 0 0 0 4-.8" />
  ...
  link: (
    <>
      ...
      <path d="M14 10.5a4 4 0 0 0-5.7-.4l-3 3a4 4 0 1 0 5.7 5.7l1.2-1.2" />
    </>
  ),
  mail: (
    <>
